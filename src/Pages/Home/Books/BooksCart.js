...
const BooksCart = ({ book }) => {
    ...
    return (
        ...
        <div class="container w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-lg mt-5 mx-auto">
            <img class="object-cover object-center w-full h-96" src={img} alt="avatar" />
            <div class="px-6 py-4 bg-gray-100">
                <h1 class="text-xl font-semibold text-gray-800 ">{book_title}</h1>
